...
declare global {
  ...
  const form: (typeof import("./components/modal_app/index"))["default"]
  const forwardRef: typeof import('react')['forwardRef']
  const install: typeof import('./components/modal_app/install')['default']
  const lazy: typeof import('react')['lazy']
  const memo: typeof import('react')['memo']
  const modal: (typeof import("./components/modal_app/index"))["default"]
